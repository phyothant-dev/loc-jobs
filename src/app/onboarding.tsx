...
const PAGES = [
  {
    ...
    description: 'Browse jobs posted by people near you. Filter by type, category, location, and price.',
    color: '#FF6B35',
    bg: '#FFF4ED',
  },
  {
    ...
    title: 'Chat & Apply',
    description: 'Apply to jobs you like, chat with job posters, and negotiate directly in the app.',
    color: '#6366F1',
    bg: '#EEF2FF',
  },
  {
    ...
    description: 'Complete jobs, earn money, and build your reputation with ratings and reviews.',
    color: '#2ECC71',
    bg: '#E8F8F0',
  },
]

function PageAnimation({ icon, color, bg, index, currentIndex }: {
...
export default function OnboardingScreen({ onDone }: { onDone: () => void }) {
  ...
  const animateTransition = useCallback((toPage: number) => {
      ...
      <View style={styles.footer}>
        ...
        <View style={{ flexDirection: 'row', gap: Spacing.three, width: '100%' }}>
          {page < PAGES.length - 1 ? (
            ...
            <Pressable
              onPress={onComplete}
              style={[styles.btn, styles.fullBtn, { backgroundColor: PAGES[page].color }]}
            >
