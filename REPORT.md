...
A medium-size diagram covering the app: the 8 domain entities (mirroring the database), the 4 context providers, the key services, and the main screens — grouped into namespaces, with 1-to-many cardinality on the entity relationships.
...
### 2.4.1 Authentication & Onboarding
...
### 2.4.2 Post, Apply & Accept/Reject
...
### 2.4.3 Chat, Complete, Review & Verified Badge
