...
The class diagram covers both the frontend domain models (mirroring the database entities) and the frontend architecture classes: the context providers and the main screens.
